    ...
    return (
        <div style={{ backgroundColor: '#f8f8f8' }} className='career-page overflow-hidden'>
            <div className="container contain">
                ...
                At KYonex Technologies, we're not just building software – we're creating impactful solutions that drive change. Explore our career opportunities and join a team that values innovation, growth, and collaboration. Together, let's shape the future of technology.
                </p>
